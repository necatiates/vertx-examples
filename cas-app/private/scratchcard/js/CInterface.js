function CInterface(){
    ...
    this._init = function(){
        ...
        _oTextHead = new createjs.Text(TEXT_HEAD,"bold 50px "+PRIMARY_FONT, "#ffe603");
        _oTextHead.x = 980;
        _oTextHead.y = 110;
        ...
        for (var i=0; i<3; i++){
            ...
            for (var j=0; j<3; j++){
                _aTextNumber[i][j] = new createjs.Text(PRIZE[index].formatDecimal(2, ".", ",") +" "+TEXT_CURRENCY,"bold 28px "+PRIMARY_FONT, "#ffffff");
        ...
        _oBuyCardBut = CTextToggle(CANVAS_WIDTH/2,485,oSprite,TEXT_BUYCARD,PRIMARY_FONT,"#ffffff",30,false,s_oStage);
        _oBuyCardBut.addEventListener(ON_MOUSE_UP, s_oGame.startPlay, this);        
        
        var pBetPos = {x:CANVAS_WIDTH/2,y:418};
        
        _oBetText = new createjs.Text(TEXT_CARD_VALUE,"bold 28px "+PRIMARY_FONT, "#ffffff");
        ...
        _oCreditText = new createjs.Text(TEXT_CREDIT,"bold 28px "+PRIMARY_FONT, "#ffffff");
        ...
        _oTotWinText = new createjs.Text(TEXT_WIN_AMOUNT,"bold 28px "+PRIMARY_FONT, "#ffffff");
    ...
    this.advice = function(type,pos){
        ...
        _oTextBack = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#000000");
        _oTextBack.x = iStartPos.x+2;
        _oTextBack.y = iStartPos.y+2;
        _oTextBack.textAlign="center";
        _oText = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#ffffff");          
