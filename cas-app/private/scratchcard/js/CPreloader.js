function CPreloader(){
    ...
    this.attachSprites = function(){
       ...
       _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(500, CANVAS_HEIGHT - 50, 1,30);
       _oContainer.addChild(_oMaskPreloader);
       
       _oProgressBar.mask = _oMaskPreloader;
       _oLoadingText = new createjs.Text("0%","30px OpenSans-BoldItalic", "#fff");
       _oLoadingText.x = CANVAS_WIDTH/2;
       _oLoadingText.y = CANVAS_HEIGHT - 65;
    ...
    this.refreshLoader = function(iPerc){
        ...
        _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(500, CANVAS_HEIGHT - 50, iNewMaskWidth,30);
    };
