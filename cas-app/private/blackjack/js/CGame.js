function CGame(oData){
    ...
    this.attachCardToDeal = function(pStartingPoint,pEndingPoint,bDealer,iCardCount){
            ...
            if(bDealer){
                ...
                if(_bDealerLoseInCurHand){
                    ...
                    }while( (_iDealerValueCard + iValue) > 21 || ((_iDealerValueCard + iValue) < _oSeat.getHandValue(0) && _oSeat.getHandValue(0) < 21));
    ...
    this._checkAvailableActionForPlayer = function(){	
            ...
            if(_oSeat.getHandValue(0) > 8 && _oSeat.getHandValue(0) < 16 && _oSeat.getCredit() >= _oSeat.getCurBet()*1.5){
