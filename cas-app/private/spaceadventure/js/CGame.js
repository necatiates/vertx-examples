            ...
            //PLAYER MUST LOSE
             do{
                ...
                if(!_iCurRes.bonus){
                        ...
                        do{
                                var bRet = this.generateFinalSymbols();
                        }while(bRet === false || (_iTotWin*_iCurBet) > _iCurRes.maxWin || _bBonus);
                }else{
                                //GET A BONUS
                                do{
                                        var bRet = this.generateFinalSymbols();
                                ...
                                }while(bRet === false || (_iTotWin*_iCurBet) > _iCurRes.maxWin || _bBonus === false || BONUS_PRIZE[iIndex][0] > _iCurRes.maxWin);
