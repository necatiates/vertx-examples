 ...
 */
public class AuthorizedPathHandlerImpl implements AuthorizedPathHandler {

    private static final Logger log = LoggerFactory.getLogger(AuthorizedPathHandlerImpl.class);
    ...
    public AuthorizedPathHandlerImpl(String root, ClassLoader classLoader) {
        this.classLoader = classLoader;
        setRoot(root);
    }

    public AuthorizedPathHandlerImpl() {
        classLoader = null;
    }
    ...
    @Override
    public AuthorizedPathHandler setAllowRootFileSystemAccess(boolean allowRootFileSystemAccess) {
        this.allowRootFileSystemAccess = allowRootFileSystemAccess;
        return this;
    }

    @Override
    public AuthorizedPathHandler setWebRoot(String webRoot) {
        setRoot(webRoot);
        return this;
    }

    @Override
    public AuthorizedPathHandler setFilesReadOnly(boolean readOnly) {
        this.filesReadOnly = readOnly;
        return this;
    }

    @Override
    public AuthorizedPathHandler setMaxAgeSeconds(long maxAgeSeconds) {
        if (maxAgeSeconds < 0) {
    ...
    @Override
    public AuthorizedPathHandler setMaxCacheSize(int maxCacheSize) {
        if (maxCacheSize < 1) {
    ...
    @Override
    public AuthorizedPathHandler setCachingEnabled(boolean enabled) {
        this.cachingEnabled = enabled;
        return this;
    }

    @Override
    public AuthorizedPathHandler setDirectoryListing(boolean directoryListing) {
        this.directoryListing = directoryListing;
        return this;
    }

    @Override
    public AuthorizedPathHandler setDirectoryTemplate(String directoryTemplate) {
    ...
    @Override
    public AuthorizedPathHandler setEnableRangeSupport(boolean enableRangeSupport) {
        this.rangeSupport = enableRangeSupport;
        return this;
    }

    @Override
    public AuthorizedPathHandler setRole(String role) {
        this.role = role;
        return this;
    }

    @Override
    public AuthorizedPathHandler setIncludeHidden(boolean includeHidden) {
        this.includeHidden = includeHidden;
        return this;
    }

    @Override
    public AuthorizedPathHandler setCacheEntryTimeout(long timeout) {
        if (timeout < 1) {
    ...
    @Override
    public AuthorizedPathHandler setIndexPage(String indexPage) {
    ...
    @Override
    public AuthorizedPathHandler setAlwaysAsyncFS(boolean alwaysAsyncFS) {
        this.alwaysAsyncFS = alwaysAsyncFS;
        return this;
    }

    @Override
    public synchronized AuthorizedPathHandler setEnableFSTuning(boolean enableFSTuning) {
    ...
    @Override
    public AuthorizedPathHandler setMaxAvgServeTimeNs(long maxAvgServeTimeNanoSeconds) {
