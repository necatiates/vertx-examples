...
public class Runner {
  ...
  static class JSAuthJDBC {
    public static void main(String[] args) {
      Runner.runJSExample("io/vertx/example/web/app/server.js");
    }
  }
  ...
  static class GroovyAuthJDBC {
    public static void main(String[] args) {
      Runner.runGroovyExample("io/vertx/example/web/app/server.groovy");
    }
  }
  ...
  static class RubyAuthJDBC {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/web/app/server.rb");
    }
  }
